   ...
   <head>
	  ...
	  <?php
		...
		if(($toDay <=> $tStart) < 0){ //時機未到
		  ...
		  echo "<div class='title'><h2>2021年台灣節約用電抽獎活動</h2></div>"."<div class='topnav'><a href='../Home/index.php'>首頁</a><a href='../Bulletin/index.php'>公佈欄</a><a href='../Info/index.php'>活動辦法</a><a href='../JoinLottery/index.php'>活動報名</a><a href='../ShowAward/index.php'>得獎名單</a><div class='topnavA2'><a href='../../../Modules/Home/index.php' >參賽者/管理專區</a></div></div>".
		  "<div class='content'><div class='table-wrapper'><table class='table'><thead><tr><th style='background-color: rgba(0, 100, 0, 0.9); border-bottom: 1px solid #ddd;'><h2>報名資料填寫</h2></th></tr></thead></table><table class='table'><th>".
		  "<body><font color='red'><h1>活動時間尚未開始! </h1></font><br/>".
		  "</th></table></div></div>".
		  "<div class='footer'><div class='footerText'><p> 主辦單位:&nbsp;中國電力公司 </p><p> Copyright&copy;2021&nbsp;Taurus&nbsp;Studio(作者:&nbsp;周彥廷).&nbsp;All&nbsp;rights&nbsp;reserved. </p></div></div>";
		  exit();
		 ...
		 $signUpError = "活動已截止!";
		  ...
		  echo "<div class='title'><h2>2021年台灣節約用電抽獎活動</h2></div>"."<div class='topnav'><a href='../Home/index.php'>首頁</a><a href='../Bulletin/index.php'>公佈欄</a><a href='../Info/index.php'>活動辦法</a><a href='../JoinLottery/index.php'>活動報名</a><a href='../ShowAward/index.php'>得獎名單</a><div class='topnavA2'><a href='../../../Modules/Home/index.php' >參賽者/管理專區</a></div></div>".
		  "<div class='content'><div class='table-wrapper'><table class='table'><thead><tr><th style='background-color: rgba(0, 100, 0, 0.9); border-bottom: 1px solid #ddd;'><h2>報名資料填寫</h2></th></tr></thead></table><table class='table'><th>".
		  "<body><font color='red'><h1>活動已截止! </h1></font><br/>"."</th></table></div></div>".
		  "<div class='footer'><div class='footerText'><p> 主辦單位:&nbsp;中國電力公司 </p><p> Copyright&copy;2021&nbsp;Taurus&nbsp;Studio(作者:&nbsp;周彥廷).&nbsp;All&nbsp;rights&nbsp;reserved. </p></div></div>";;
		  exit();
		}else{//天賜良機
	  ?>
