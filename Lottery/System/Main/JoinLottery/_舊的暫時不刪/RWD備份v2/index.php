...
<html>
   ...
   <body>
	...
	<thead >
		  ...
		  <tr>
          <td style="background-color: rgba(255, 255, 255, 0.9);padding: 15px;text-align: cent;"><h3>抽獎活動報名資料填寫</h3></td>
		  </tr>
	<!--
	<tbody>
		  <tr>
          <td style="background-color: rgba(255, 255, 255, 0.9); border-bottom: 1px solid #ddd;"><h3>抽獎活動報名資料填寫</h3></td>
		  </tr>
	</tbody>
	-->
	</table>
