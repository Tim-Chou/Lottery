...
<?php
//置頂
              $sql = "SELECT * FROM top_bulletin";
			  $result = $db_link->query($sql);
			  $total_records__top = $result->rowCount();
			  $allBulletin["top"] = $result->fetch(PDO::FETCH_ASSOC);

//
//"非"置頂
              $sql = "SELECT * FROM notop_bulletin";
			  $result = $db_link->query($sql);
			  //$total_records__top = $result->rowCount();
			  $allBulletin["notop"] = $result->fetch(PDO::FETCH_ASSOC);

//
			  $sql = "SELECT * FROM bulletin ORDER BY bStartDate ASC";
			  $result = $db_link->query($sql);
		  ...
		  //$allBulletinSql["top"] = "SELECT * FROM top_bulletin";
		  //$allBulletinSql["notop"] = "SELECT * FROM notop_bulletin";
	 ...
	 ?>
		   ...
		   <?php
			 ...
			 if($row["bOnTop"] == "Y"){ //置頂
			      ...
			      $arrayOnTop[$onTopIndex++] = "<tr><td nowrap='nowrap'><a href='Show_Context.php?bID=".GetSQLValueString($row["bID"],"int")."' >".$titleStr."</a></td></tr>";
			   ...
			   $arrayNonTop[$nonTopIndex++] = "<tr><td nowrap='nowrap'><a href='Show_Context.php?bID=".GetSQLValueString($row["bID"],"int")."' >".$titleStr."</a></td></tr>";
			 }
